...
// Formato de los temas: clave de tema → selector CSS donde aplica.
const THEMES = { light: "", dark: ".dark" } as const

/** Configuración de un gráfico: por cada serie, etiqueta y color (o color por tema). */
...
/** Item de payload que entrega Recharts al tooltip/leyenda (forma mínima usada aquí). */
...
/** Resuelve la config de una serie a partir de un item de payload de Recharts. */
